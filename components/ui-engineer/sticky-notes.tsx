...
const StickyNotes = () => {
   const [notes, setNotes] = useState([
      ...
      },
      {
         ...
         rotation: 4,
         zIndex: 3,
         text: "Click here to create your account and unlock a world of possibilities where your wildest dreams can take flight. Join us today to embark on a journey of self-discovery, creativity, and endless inspiration—unleash the full potential of your imagination and turn your aspirations into reality !",
      },
   ]);
